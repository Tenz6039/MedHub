          ...
          <div class="medicine-info">
            ...
            <div class="medicine-list">
              <div
                ...
                class="medicine-item"
              >
                <div class="medicine-item-box">
                  <span class="medicine-name">{{ item.name }}</span>
                  <span class="medicine-num">x{{ item.number }}</span>
                </div>
                <span class="medicine-price">￥{{ item.amount ? item.amount.toFixed(2) : '' }}</span>
              </div>
            </div>
            <div class="medicine-all-amount">
              <label>药品小计</label>
              <span>￥{{
          ...
          <div class="amount-info">
            ...
            <div class="amount-list">
              <div class="medicine-amount">
                <span class="amount-name">药品小计：</span>
              ...
              <div class="package-amount">
                <span class="amount-name">包装费：</span>
                <span class="amount-price">￥{{
                  diaForm.packAmount
