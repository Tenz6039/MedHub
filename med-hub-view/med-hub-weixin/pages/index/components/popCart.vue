  ...
  <view class="cart_pop" @click.stop="openOrderCartList = openOrderCartList">
    ...
    <scroll-view class="card_order_list" scroll-y="true" scroll-top="40rpx">
      ...
      >
        <view
          class="type_item"
          v-for="(obj, index) in item.medicineList"
          :key="index"
        >
          <view class="dish_img"
            ><image
          ...
          <view class="dish_info">
            ...
            <view class="dish_active">
              <image
                ...
                @click.stop="redMedicineFromCartAction(obj, '购物车')"
                class="dish_red"
                mode=""
              ></image>
              ...
              <image
                ...
                class="dish_add"
                @click.stop="addMedicineToCartAction(obj, '购物车')"
                mode=""
              ></image>
            </view>
          </view>
...
export default {
  ...
  methods: {
    ...
    addMedicineToCartAction(obj, item) {
      this.$emit("addMedicineToCartAction", { obj: obj, item: item });
    },
    redMedicineFromCartAction(obj, item) {
      this.$emit("redMedicineFromCartAction", { obj: obj, item: item });
    },
  },
};
</script>
