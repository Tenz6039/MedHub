  ...
  <view>
    <view class="box">
      <view class="orderInfoTip">
        ...
        <view class="rejectionReason" v-if="orderDetailsData.status === 7 || orderDetailsData.status === 6">
          <text v-if="orderDetailsData.status === 7 && (orderDetailsData.payStatus === 1 || orderDetailsData.payStatus === 2)">退款成功</text>
